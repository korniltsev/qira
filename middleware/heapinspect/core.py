...
class HeapInspector(object):
    ...
    def __init__(self, pid, proc):
        ...
        self.ld_path = 'hui' # todo self.proc.ld
        ...
        print('libc_info', libc_info)
        print('MallocState', self.MallocState)
        print('MallocChunk', self.MallocChunk)
        print('TcacheStruct', self.TcacheStruct)
    ...
    def fastbins(self):
        ...
        for index, fastbin_head in enumerate(self.main_arena.fastbinsY):
            print('fastbin idx ', index, hex(fastbin_head))
